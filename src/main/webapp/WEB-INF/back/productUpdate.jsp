				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
							<div class="actionButton">
								<a onclick="fromSubmit('saveUpdateProduct');this.blur()">
								<button type="button" class="btn btn-primary btn-lg">保存</button>
								</a>
							</div>
							<div class="panel" style="text-align: center">
								<div class="panel-heading">
									<h3 class="panel-title" id="useListH3">商品修改</h3>
								</div>
								<div class="panel-body">
									<table class="table table-bordered">
										...
										<tr>
											...
											<td>种类</td>
											<td><input type="text" name="cateId" value="${product.category.cateId}"></td>
										</tr>
										<tr>
											<td>商品名称</td>
										...
										<tr>
											<td>商品简介</td>
											<td><input type="text" name="presentation" value="${product.presentation}"/></td>
											<td>状态</td>
