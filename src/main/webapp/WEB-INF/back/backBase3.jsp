		...
		<div class="sidebar-scroll">
			<nav>
				<ul class="nav">
					...
					<li><a href="${pageContext.request.contextPath}/back/saleList2" onclick="liHoverChange(this)" class="active"><i class="lnr lnr-chart-bars"></i><span>销售榜单</span></a></li>
					<li><a href="${pageContext.request.contextPath}/back/product" onclick="liHoverChange(this)"><i class="lnr lnr-home"></i> <span>商品管理</span></a></li>
